...
<div
	...
	<div class="rmp-rating-widget js-rmp-rating-widget">
		...
		<div class="rmp-rating-widget__icons">
			<ul class="rmp-rating-widget__icons-list js-rmp-rating-icons-list">
				<?php for ( $icons_count = 0; $icons_count < $max_rating; $icons_count++ ) : ?>
					<li class="rmp-rating-widget__icons-list__icon">
						<button
							class="js-rmp-rating-icon js-rmp-rating-item <?php echo $rating_icon_type; ?> <?php echo $icon_classes[ $icons_count ]; ?>"
							data-descriptive-rating="<?php echo $rmp_custom_strings[ 'star' . ( $icons_count + 1 ) ]; ?>"
							data-value="<?php echo $icons_count + 1 ?>"><span
								class="visually-hidden"><?php echo $rmp_custom_strings[ 'star' . ( $icons_count + 1 ) ]; ?></span></button>
					</li>
				<?php endfor; ?>
			</ul>
		</div>
		...
		<p
			class="rmp-rating-widget__results js-rmp-results <?php echo ! $avg_rating ? 'rmp-rating-widget__results--hidden' : '' ?>">
			<?php echo $results_text; ?>
		</p>

		<p
			class="rmp-rating-widget__not-rated js-rmp-not-rated <?php echo $avg_rating ? 'rmp-rating-widget__not-rated--hidden' : '' ?>">
